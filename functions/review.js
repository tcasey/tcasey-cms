...
exports.reviews = function () {
  var url = "https://itunes.apple.com/us/app/vivint-solar/id1289441541?mt=8&isWebExpV2=true&dataOnly=true";
  return (0, _axios2.default)(url).then(function (result) {
    var data = result.data.pageData.reviews.map(function (reviews) {
...
exports.handler = function (event, context, callback) {
  exports.reviews().then(function (result) {
    callback(null, {
      statusCode: 200,
      headers: {
...
var hasFlag = __webpack_require__(35);
